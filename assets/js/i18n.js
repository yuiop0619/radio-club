...
(function () {
  ...
  var DICT = {
    cn: {
      ...
      /* 第二批：画廊 / 梦境 / 集章 / 示例 / 环境音 / 分享图 / 常客墙 */
      gallery: '画廊', dreams: '梦境',
      mastersTitle: '解梦会诊的七位', mastersSub: '你睡着的时候，他们在隔壁房间等你',
      mastersTip: '在「精神分析」里，他们会轮流接过你的梦；这里可以慢慢看他们是谁。',
      goPsyche2: '去会诊 →',
      stampCard: '集章卡', stampTip: '在这家店做过的事，会一枚枚盖上来',
      stampEmpty: '还没有章。先坐下，先说一句。', stampGot: '盖了一枚章',
      stampProgress: '已集',
      demoLoad: '载入示例数据', demoClear: '清除示例数据',
      demoBadge: '示例数据 · DEMO', demoClearBtn: '清除',
      demoHint: '没带故事来也没关系。先载入一份示例，看看这家店一轮是怎么走完的。',
      demoDone: '示例数据已载入。现在可以直接去看鉴定书了。',
      demoCleared: '示例数据已清除，本机档案回到你自己的样子。',
      ambient: '电台', ambientTip: '打开店里的环境音：黑胶、低频与电台杂音',
      ambientOn: '电台开着', ambientOff: '电台已关',
      shareCard: '生成分享图', shareCardDoing: '正在画……', shareCardDone: '分享图已生成。',
      shareCardFail: '这台设备不支持生成图片，可以用「打印」或截图。',
      dreamTitle: '梦境档案', dreamSub: '梦不占地方，但记下来会留下形状',
      dreamAdd: '记一个梦', dreamDate: '日期', dreamBody: '梦到了什么',
      dreamMood: '醒来时的感觉', dreamTag: '反复出现的意象', dreamSave: '记下来',
      dreamEmpty: '档案还是空的。第一个梦，你来记。',
      dreamSaved: '记下了。它会排在时间线上。', dreamDeleted: '删掉了。',
      dreamCount: '个梦', dreamTake: '带去会诊 →',
      regulars: '常客墙', regularsSub: '酒保记得每一位常客。第二次来，他们会先开口。',
      board: '数据看板', boardSub: '你在这家店留下的全部痕迹',
      bdVisits: '累计到店', bdToday: '今日到店', bdOrders: '点单数', bdItems: '共点了',
      bdTarot: '塔罗次数', bdNotes: '树洞纸条', bdDreams: '梦境记录', bdStamps: '集章',
      you: '你', firstSeen: '初次到店', lastSeen: '最近到店', favDrink: '常点的',
      never: '还没来过', justNow: '刚刚',
      skeletonTip: '正在把今晚的东西摆上桌……'
    },
    jp: {
      /* 导航 */
      /* 导航 */
      ...
      gallery: '画廊', dreams: '夢の記録',
      mastersTitle: '夢診断の七人', mastersSub: 'あなたが眠っている間、彼らは隣の部屋で待っている',
      mastersTip: '「精神分析」では、彼らが順に夢を受け取る。ここでは、彼らが誰かをゆっくり見られる。',
      goPsyche2: '診断へ',
      stampCard: 'スタンプ帳', stampTip: 'この店でしたことが、一つずつ押されていく',
      stampEmpty: 'まだ判がない。まず座って、一言。', stampGot: '判を一つ押した',
      stampProgress: '取得',
      demoLoad: 'サンプルを読み込む', demoClear: 'サンプルを消す',
      demoBadge: 'サンプル · DEMO', demoClearBtn: '消す',
      demoHint: '話を持って来なくてもいい。まずサンプルで、この店の一周を見て。',
      demoDone: 'サンプルを入れた。鑑定書まで見られる。',
      demoCleared: 'サンプルを消した。端末の中はあなたのものに戻った。',
      ambient: 'ラジオ', ambientTip: '店の音を流す：レコード、低音、ラジオの雑音',
      ambientOn: 'ラジオは流れている', ambientOff: 'ラジオを止めた',
      shareCard: '共有画像を作る', shareCardDoing: '描いている……', shareCardDone: '画像ができた。',
      shareCardFail: 'この端末では画像を作れない。「印刷」か画面保存で。',
      dreamTitle: '夢の記録', dreamSub: '夢は場所を取らないが、書けば形になる',
      dreamAdd: '夢を記す', dreamDate: '日付', dreamBody: 'どんな夢だったか',
      dreamMood: '目覚めたときの感じ', dreamTag: '繰り返し出るもの', dreamSave: '記録する',
      dreamEmpty: '記録はまだ空。最初の夢は、あなたから。',
      dreamSaved: '記録した。タイムラインに並ぶ。', dreamDeleted: '消した。',
      dreamCount: 'つの夢', dreamTake: '診断へ持っていく',
      regulars: '常連の壁', regularsSub: 'バーテンは常連を覚えている。二度目は、先に声をかける。',
      board: 'データ', boardSub: 'この店に残した、すべての痕',
      bdVisits: 'のべ来店', bdToday: '今日の来店', bdOrders: '注文', bdItems: '点数',
      bdTarot: 'タロット', bdNotes: '木の穴', bdDreams: '夢の記録', bdStamps: '判',
      you: 'あなた', firstSeen: '初来店', lastSeen: '最近の来店', favDrink: 'よく飲むもの',
      never: 'まだ来ていない', justNow: 'たった今',
      skeletonTip: '今夜のものを並べている……'
    }
  };
